...
const filterProducs = (products, category) => {
...
export {shotenText, searchProducts, filterProducs , creatQueryObject, getInitialQuery,sumProducts, productQuantity}